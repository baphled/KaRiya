...
var _ = Describe("EditSettingsScreen", func() {
	...
	BeforeEach(func() {
		...
		screen = configure.NewEditSettingsScreen(configtypes.DomainSystem, settings)
	})
	...
	Describe("NewEditSettingsScreen", func() {
		...
		It("handles empty settings list", func() {
			emptyScreen := configure.NewEditSettingsScreen(configtypes.DomainProfile, []*configtypes.ConfigurationSetting{})
...
var _ = Describe("ReviewChangesScreen", func() {
	...
	BeforeEach(func() {
		...
		screen = configure.NewReviewChangesScreen(configtypes.DomainSystem, changes, original, labels)
	})
...
var _ = Describe("ConfirmScreen", func() {
	...
	BeforeEach(func() {
		screen = configure.NewConfirmScreen(configtypes.DomainSystem, 3)
	})
...
var _ = Describe("CompleteScreen", func() {
	...
	BeforeEach(func() {
		screen = configure.NewCompleteScreen(configtypes.DomainProfile, 5)
	})
	...
	Describe("View", func() {
		...
		It("shows no changes message when count is zero", func() {
			emptyScreen := configure.NewCompleteScreen(configtypes.DomainSystem, 0)
			view := emptyScreen.View()
...
var _ = Describe("FailedScreen", func() {
	...
	BeforeEach(func() {
		screen = configure.NewFailedScreen(configtypes.DomainExport, "Connection timed out")
	})
	...
	Describe("NewFailedScreen", func() {
		...
		It("uses default error message when empty", func() {
			emptyScreen := configure.NewFailedScreen(configtypes.DomainSystem, "")
