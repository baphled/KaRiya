...
func (i *Intent) getStateContent() string {
	...
	case StateView:
		return facts.RenderFactDetail(i.context.SelectedFact)
	case StateEditor:
		return i.getEditorContent()
	case StateDeleteConfirm:
		return facts.RenderDeleteConfirm(i.context.FactToDelete)
	case StateResults:
		return facts.RenderResults(i.context.TotalFacts, len(i.context.Facts))
	case StateCompleted:
...
func (i *Intent) getEditorContent() string {
	...
	return facts.RenderEditorFallback(i.context.EditingFact, i.context.HasFormErrors())
}
