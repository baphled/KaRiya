...
// Intent orchestrates the configuration workflow using the activeScreen + ModalRegistry pattern.
type Intent struct {
	*intents.BaseIntent
...
//
// Expected: intentcontext must be valid.
// Side effects: None.
...
//
// Returns: A fully initialized IntentContext ready for use.
// Side effects: None.
...
//
// Returns: A ConfigurationState value.
// Side effects: None.
...
//
// Returns: A fully initialized config.Config ready for use.
// Side effects: None.
...
//
// Returns: A ConfigurationDomain value.
// Side effects: None.
...
//
// Returns: A fully initialized SystemResult ready for use.
// Side effects: None.
...
//
// Returns: A fully initialized feedback.Modal ready for use.
// Side effects: None.
