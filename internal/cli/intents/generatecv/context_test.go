	...
	Describe("Validate", func() {
		...
		Context("with nil context", func() {
			It("should return error", func() {
				var ctx *generatecv.IntentContext
				Expect(ctx.Validate()).To(MatchError("IntentContext cannot be nil"))
			})
		})
		...
		Context("with empty profiles", func() {
			It("should return error", func() {
				...
				Expect(ctx.Validate()).To(MatchError("IntentContext must have at least one available profile"))
			})
		})
		...
		Context("with empty events", func() {
			It("should return error", func() {
				...
				Expect(ctx.Validate()).To(MatchError("IntentContext must have at least one event"))
			})
		})
