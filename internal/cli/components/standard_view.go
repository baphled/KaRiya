...
// LogoRenderer defines the interface for logo components.
// Both ASCIILogo and uikit/display.Logo satisfy this interface.
...
// Accepts any LogoRenderer implementation (ASCIILogo, uikit/display.Logo, etc.)
