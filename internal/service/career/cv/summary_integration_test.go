...
var _ = Describe("Summary Format Integration", func() {
	...
	Describe("BuildSections summary format", func() {
		It("produces prose with exactly 3 bullet-sentences joined by '. '", func() {
			...
			Expect(summaryText).NotTo(ContainSubstring("Built AI-powered customer service dashboards"), "4th bullet should not appear")
			...
			Expect(dotSpaceSeparatorCount).To(Equal(2), "expect exactly 2 '. ' separators for 3 sentences")
	...
	Describe("Preview screen summary display", func() {
		It("renders summary with word-wrapping, not a wall of text", func() {
			...
			// Summary section should contain only top 3 bullets
			...
			// 4th and 5th bullets should NOT appear in summary section
