...
// LinkSkill mocks base method.
func (m *MockEventRepository) LinkSkill(arg0 context.Context, arg1, arg2 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LinkSkill", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// LinkSkill indicates an expected call of LinkSkill.
func (mr *MockEventRepositoryMockRecorder) LinkSkill(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LinkSkill", reflect.TypeOf((*MockEventRepository)(nil).LinkSkill), arg0, arg1, arg2)
}
