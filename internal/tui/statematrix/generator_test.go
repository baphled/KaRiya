...
var _ = Describe("Scanner", func() {
	...
	Describe("FindIntentFiles", func() {
		It("should find all intent files in internal/tui/intents/", func() {
...
var _ = Describe("Parser", func() {
	...
	Describe("ParseIntentFile", func() {
		It("should parse intent states from captureevent subdirectory", func() {
			file := filepath.Join(projectRoot, "internal", "tui", "intents", "captureevent", "constants.go")
		...
		It("should handle files with no states", func() {
			...
			file := filepath.Join(projectRoot, "internal", "tui", "intents", "captureevent", "result.go")
			component := statematrix.ParseIntentFile(file)
