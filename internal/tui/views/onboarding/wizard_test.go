...
var _ = Describe("Wizard", func() {
	...
	BeforeEach(func() {
		modal = onboarding.NewWizard(80, 24)
		// Initialize the form for proper rendering
		modal.Init()
	})

	Describe("NewWizard", func() {
		It("should create a new wizard", func() {
	...
	Describe("Update", func() {
		...
		Context("escape key", func() {
			...
			It("should NOT close wizard on Esc at step 0 (mandatory onboarding)", func() {
	...
	Describe("Data Collection", func() {
		Context("with pre-filled data", func() {
			It("should accept existing profile config", func() {
				...
				modalWithData := onboarding.NewWizardWithConfig(80, 24, existingConfig)
