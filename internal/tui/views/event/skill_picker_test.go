...
var _ = Describe("SkillPicker", func() {
	var (
		modal  *SkillPicker
		theme  themes.Theme
	...
	Describe("NewSkillPicker", func() {
		...
		It("should use default theme if nil", func() {
			modal := NewSkillPicker(skills, nil)
		...
		It("should filter out nil skills", func() {
			...
			modal := NewSkillPicker(skillsWithNil, theme)
		...
		It("should keep partially populated skills for placeholder rendering", func() {
			...
			modal := NewSkillPicker([]display.Skill{placeholderSkill}, theme)
	...
	Describe("Visibility", func() {
		...
		It("should reset selection when shown", func() {
			...
			modal.Show()
			Expect(modal.selectedSkill).To(Equal(display.Skill{}))
		})
	})
	...
	Describe("Selection", func() {
		...
		It("should close without selection on Backspace", func() {
	...
	Describe("View Rendering", func() {
		...
		It("should show empty message when no skills", func() {
			emptyModal := NewSkillPicker([]display.Skill{}, theme)
	...
	Describe("Window Resize", func() {
		...
		It("should handle a very small window resize", func() {
			modal.Update(tea.WindowSizeMsg{Width: 80, Height: 10})
