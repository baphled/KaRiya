//go:generate mockgen -destination=../../../testutil/mocks/intent/browse_event_service_mock.go -package=mockintent -mock_names=EventCRUDService=MockBrowseEventCRUDService,EventSkillService=MockBrowseEventSkillService github.com/baphled/kariya/internal/tui/intents/browsetimeline EventCRUDService,EventSkillService
...
// SkillCreator defines the interface for skill creation operations.
