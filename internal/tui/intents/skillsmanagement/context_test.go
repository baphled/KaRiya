...
var _ = Describe("Context", func() {
	...
	Describe("Filters", func() {
		...
		Describe("HasActiveFilters", func() {
			It("should return false for a nil receiver", func() {
				var filters *skillsmanagement.Filters
		...
		Describe("Clear", func() {
			It("should do nothing for a nil receiver", func() {
				var filters *skillsmanagement.Filters
				Expect(func() { filters.Clear() }).NotTo(Panic())
			})
