...
type modelOptions struct {
	registrar IntentRegisterer
	version   string
}

// WithIntentRegisterer sets a custom intent registrar (useful for testing).
//
// Expected:
...
// Side effects:
//   - None.
func WithIntentRegisterer(registrar IntentRegisterer) ModelOption {
...
func NewModel(
	...
	if registrar == nil {
		registrar = NewDefaultIntentRegisterer(&RegistrarConfig{
