...
echo "=== Intent layer ==="
go generate ./internal/cli/intents/captureevent/...
go generate ./internal/cli/intents/burst_management/...
go generate ./internal/cli/intents/skillsmanagement/...
go generate ./internal/cli/intents/browsetimeline/...
