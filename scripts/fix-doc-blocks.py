...
Usage:
    cat file.go | ./fix-doc-blocks.py > file_fixed.go
    ./fix-doc-blocks.py file.go > file_fixed.go
    ./fix-doc-blocks.py --in-place file.go
...
def generate_documentation(
    func_name: str, params: List[str], returns: List[str], existing_comment: List[str]
) -> List[str]:
    """
    ...
    if params:
        ...
        for param in params:
            ...
            if "theme" in param_name.lower():
                doc_lines.append(
                    f"//   - th must be a valid theme instance (can be nil)."
                )
                    ...
                    if func_match:
                        ...
                        if func_name[0].isupper():
                            ...
                            if not has_complete_documentation(comment_lines):
                                ...
                                new_doc = generate_documentation(
                                    func_name, params, returns, comment_lines
                                )
