...
session-start:
	...
	@echo "  Tier 3: docs/PROJECT_HANDBOOK.md         - Full handbook (2000+ lines)"
	@echo ""
	@echo "  Key docs:"
	@echo "    docs/rules/STRICT_REQUIREMENTS_SUMMARY.md  - Mandatory requirements"
	@echo "    docs/rules/senior-engineer-guidelines.md   - Engineering standards"
	@echo "    docs/INTENT_ARCHITECTURE_GUIDE.md          - Intent patterns"
	@echo ""
	@echo "================================================"
